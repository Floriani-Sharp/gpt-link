...
EXPLAIN_TOOL.addEventListener('click', function() {
  ...
  const REQUEST = `
    Pouvez-vous m'expliquer le terme "${termToExplain}" tel qu'utilisé dans le texte suivant : 
    [${contextOfTerm}] ? Je souhaiterais obtenir une réponse en français de moins de 70 mots, 
